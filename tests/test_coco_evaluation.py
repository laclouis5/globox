...
def test_evaluation_invariance_to_bboxes_order():
    ...
    dets_1 = AnnotationSet(annotations=[
        Annotation("img_1", image_size=(100, 100), boxes=[
            BoundingBox(label="cat", xmin=-1, ymin=0, xmax=2, ymax=3, confidence=0.6),
            BoundingBox(label="cat", xmin=0, ymin=0, xmax=3, ymax=3, confidence=0.5),
        ])
    ])
...
def test_predictions_missing_confidence():
    ...
    dets = AnnotationSet(annotations=[
        Annotation("img_1", image_size=(100, 100), boxes=[
            BoundingBox(label="cat", xmin=0, ymin=0, xmax=3, ymax=3),
        ])
    ])
